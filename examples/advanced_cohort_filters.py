    ...
    try:
        ...
        filters = [
            ...
            {"type": "measurement", "concept_set_id": 1, "value_min": 7.0, "value_max": 10.0,
             "days_before": 180, "filter_name": "HbA1c 7-10% in last 6 months"},
            
            # Medication requirements 
            {"type": "drug_era", "concept_set_id": 2, "era_length_min": 90,
             "days_before": 365, "filter_name": "Metformin for 90+ days in last year"},
            
            # Healthcare utilization
            {"type": "visit", "visit_concept_ids": [9202], "days_before": 90,  # Outpatient
            ...
            {"type": "multiple_conditions", "concept_set_ids": [3, 4], "logic": "ALL",
             "days_before": 1095, "filter_name": "Has both hypertension AND kidney disease"}
        ]
        ...
        results = await client.cohorts.build_incremental_cohort(
            ...
            base_name="Advanced Diabetes Study",
...
def show_filter_examples(base_url: str):
    ...
    print(f"   ✅ Added continuous enrollment requirement")
    
    print("\n2. Visit Type Filter:")
    visit_expr = client.cohorts.add_visit_filter(obs_expr, [9201, 9203], 30)  # Inpatient or ER
    print(f"   ✅ Added inpatient/ER visit requirement")
    
    print("\n3. Measurement Filter:")
    measurement_expr = client.cohorts.add_measurement_filter(
        visit_expr, 1, value_min=7.0, value_max=10.0, days_before=180
    )
    print(f"   ✅ Added HbA1c 7-10% requirement")
    
    print("\n4. Drug Era Filter:")
    drug_expr = client.cohorts.add_drug_era_filter(
        measurement_expr, 2, era_length_min=90, days_before=365
    )
    print(f"   ✅ Added 90+ day medication requirement")
    
    print("\n5. Prior Observation Filter:")
    prior_expr = client.cohorts.add_prior_observation_filter(drug_expr, 365)
    print(f"   ✅ Added 1-year prior data requirement")
    ...
    print(f"   Each rule refines the target population")
...
async def lab_values_example():
    ...
    for i, (concept_id, name, min_val, max_val, unit) in enumerate(lab_examples):
        ...
        print(f"   Filter code:")
        print(f"   expression = client.cohorts.add_measurement_filter(")
    ...
    print(f"   Perfect for clinical studies with biomarker requirements!")
...
if __name__ == "__main__":
    async def main():
        ...
        try:
            ...
            print(f"   clinically relevant cohorts that match real-world study criteria!")
