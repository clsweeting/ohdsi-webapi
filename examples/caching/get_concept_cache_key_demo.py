...
def demo_get_concept_cache_key():
    ...
    examples = [
        {"call": "get_concept(201826)", "args": [201826], "kwargs": {}},
        {"call": "get_concept(316866)", "args": [316866], "kwargs": {}},
        {
    ...
    for example in examples:
        ...
        key = get_cache_key(*example["args"], method_name=method_name, **filtered_kwargs)
