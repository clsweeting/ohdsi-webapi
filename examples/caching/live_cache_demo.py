...
def demonstrate_live_caching():
    ...
    key1 = get_cache_key(201826, method_name="ohdsi_webapi.services.vocabulary.VocabularyService.get_concept")
    print(f"   Type 2 diabetes (201826): {key1}")

    # Show key for hypertension concept
    key2 = get_cache_key(316866, method_name="ohdsi_webapi.services.vocabulary.VocabularyService.get_concept")
    print(f"   Hypertension (316866): {key2}")

    # Show key for domains
    key3 = get_cache_key(method_name="ohdsi_webapi.services.vocabulary.VocabularyService.list_domains")
