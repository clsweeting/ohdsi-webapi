...
async def quick_diabetes_demo():
    ...
    step1_cohort = CohortDefinition(
        name="Step 1: All diabetes patients",
    ...
    step2_cohort = CohortDefinition(
        name="Step 2: Male diabetes patients", 
        expression=male_expr
    )
    ...
    step3_cohort = CohortDefinition(
        name="Step 3: Male diabetes patients 40+",
        expression=age_expr
    )
