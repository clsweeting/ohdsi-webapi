...
from .exceptions import raise_for_status, WebApiError

Json = Union[Dict[str, Any], list, str, int, float, bool, None]

class HttpExecutor:
    def __init__(self, base_url: str, *, timeout: float = 30.0, auth_headers_cb=None, user_agent: str = "ohdsi-webapi-client/0.1.0", verify: Union[bool, str] = True):
    ...
    def request(self, method: str, endpoint: str, *, params: Optional[Dict[str, Any]] = None, json_body: Optional[Json] = None, headers: Optional[Dict[str, str]] = None) -> Json:
