...
from typing import Optional, Iterable, Any, Dict, List, Iterator
from ..http import HttpExecutor
from ..models.concept_set import ConceptSet, ConceptSetItem, ResolvedConceptSetItem
    ...
    def list_filtered(
        ...
        if tags:
            ...
            all_sets = [
                ...
                if cs.tags and any(
                    any(tag_filter in (tag or "").lower() for tag_filter in tags_lower)
                    for tag in cs.tags
                )
            ]
