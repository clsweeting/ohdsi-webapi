...
class TestCacheKeyGeneration:
    ...
    def test_cache_key_with_kwargs(self):
        ...
        key = get_cache_key("diabetes", method_name="VocabularyService.search", domain_id="Condition", page_size=50)
    ...
    def test_cache_key_kwargs_sorting(self):
        ...
        key1 = get_cache_key(method_name="TestService.test", zebra="last", alpha="first")
        key2 = get_cache_key(method_name="TestService.test", alpha="first", zebra="last")
        assert key1 == key2
    ...
    def test_cache_key_full_method_name_cleanup(self):
        ...
        key = get_cache_key(123, method_name="ohdsi_webapi.services.vocabulary.VocabularyService.get_concept")
...
class TestGlobalCacheFunctions:
    ...
    def test_cache_contents_data_type_formatting(self):
        ...
        for key, value, _expected_type in test_cases:
